...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (mRecyclerView != null) {
            final DisplayMetrics dm = recyclerView.getResources().getDisplayMetrics();
            mSwipeEscapeVelocity = (int)(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 120, dm) + 0.5f);
            mMaxSwipeVelocity = (int)(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 800, dm) + 0.5f);
    ...
    public abstract static class Callback {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (mCachedMaxScrollSpeed == -1) {
                mCachedMaxScrollSpeed = (int)(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, recyclerView.getResources().getDisplayMetrics()) + 0.5f);
        ...
        /**
         * Sets the resource id to use in conjunction with {@link View#setTag(int, Object)}
         * to store the previous elevation of the view.
         * @param tagId The resource id to use, as generated by the aapt tool.
         */
        public static void setTagId(int tagId) {
            if (Build.VERSION.SDK_INT >= 21) {
                ItemTouchUIUtilImpl.Lollipop.tagId = tagId;
            }
        }
    }
