...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            int defStyleRes = 0;
            TypedArray a = context.obtainStyledAttributes(attrs, (int[])getAttributeValue(context, "RecyclerView"),
                    defStyle, defStyleRes);
            String layoutManagerName = a.getString((int)getAttributeValue(context, "RecyclerView_layoutManager"));
            int descendantFocusability = a.getInt((int)getAttributeValue(context, "RecyclerView_android_descendantFocusability"), -1);
    ...
    public abstract static class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs,
            ...
            properties.orientation = a.getInt((int)getAttributeValue(context, "RecyclerView_android_orientation"), VERTICAL);
            properties.spanCount = a.getInt((int)getAttributeValue(context, "RecyclerView_spanCount"), 1);
            properties.stackFromEnd = a.getBoolean((int)getAttributeValue(context, "RecyclerView_stackFromEnd"), false);
            properties.reverseLayout = a.getBoolean((int)getAttributeValue(context, "RecyclerView_reverseLayout"), false);
            a.recycle();
            return properties;
        }
    ...
    /* package */ static Object getAttributeValue(Context context, String name) {
        try {
